...
url_regexps_remote = 'https://raw.githubusercontent.com/danlacher/ScriptsDotFileSamples/master/Pihole/pihole-regex-blocklist.txt'
install_comment = 'pihole-regex-blocklist'
